...
public class ContactsItem extends JPanel {
    ...
    * */
    public ContactsItem(User user) {
        ...
        nameLabel.setForeground(Color.decode(Theme.ContactsFrontgroundColor));
        nameLabel.setFont(new Font(Theme.globalFont,Font.PLAIN,Theme.globalFontSize));
        /*ip*/
        ipAddrLabel = new JLabel(this.ipAddr);
        ipAddrLabel.setForeground(Color.decode(Theme.ContactsFrontgroundColor));
        ipAddrLabel.setFont(new Font(Theme.globalFont,Font.PLAIN,Theme.globalFontSize));
        info = new JPanel();
        info.setLayout(new BorderLayout());
        info.add(nameLabel,"North");
        info.add(ipAddrLabel,"South");
//        this.setLayout(new BorderLayout());
//        this.add(user.avator,BorderLayout.WEST);
